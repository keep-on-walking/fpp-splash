...
if [ "$KIND" = "idle" ]; then
    ...
    # playlist mode: the frame drawn beneath video / shown in the gap
    # before the screensaver playlist starts is the text frame
    case "$DISPLAY_SEL" in playlist:*) DISPLAY_SEL="__text__" ;; esac
